...
export const TDS_RESTROOMS = [
  ...
  },
  {
    ...
    name: '버스터미널 사우스 화장실',
    nameNote: '도쿄디즈니씨 버스터미널 사우스',
    coordinates: [35.62610, 139.88120],
    generalRestroom: true, accessibleRestroom: true, babyCare: false, nursingRoom: false,
    insidePaidArea: false, generalGuestAccessible: true, pregate: true,
    pdfVerified: true, coordinateVerified: false, approximate: true,
    coordinateStatus: 'low_estimated', coordinateSourceType: 'pdf_landmark',
    source: '공식 PDF 버스터미널 사우스 노란 화장실 아이콘 (4× px 1487,2345)',
    sourceUrl: null, checkedAt: '2026-08-01',
    googlePoiName: null,
    evidence: 'PDF 「버스터미널 사우스」 표기 옆 노란+다기능. reconcile #18.',
    estimatedAccuracyMeters: 40, confidenceScore: 34,
    notes: '입구 밖. 노스와 분리 등록.',
    pdfIconId: 'TDS-PDF-18', pdfPixel: [1487, 2345],
  },
  {
    id: 'tds-r-pg03', park: 'TDS', area: 'pregate', type: 'restroom',
    name: '버스터미널 노스 화장실',
    nameNote: '도쿄디즈니씨 버스터미널 노스·배웅·마중 구역',
    generalRestroom: true, accessibleRestroom: true, babyCare: false, nursingRoom: false,
    insidePaidArea: false, generalGuestAccessible: true, pregate: true,
    pdfVerified: true, coordinateVerified: false, approximate: true,
    coordinateStatus: 'unknown', coordinateSourceType: 'pdf_icon_only',
    source: '공식 PDF 버스터미널 노스/배웅·마중 노란 화장실 아이콘',
    sourceUrl: null, checkedAt: '2026-08-01',
    googlePoiName: null,
    evidence: 'PDF 사우스(#18)와 별도인 노스·픽업 구역 노란 아이콘(reconcile #19 계열).',
    estimatedAccuracyMeters: null, confidenceScore: 10,
    notes: '위치 확인 중. 입구 밖. 기존 pg02 통합 분리를 위한 추가 레코드.',
    pdfIconId: 'TDS-MISS-02', pdfPixel: [2150, 2326],
  },
  {
    id: 'tds-r-pg04', park: 'TDS', area: 'pregate', type: 'restroom',
    name: '베이사이드 스테이션 화장실',
    nameNote: '베이사이드 스테이션·모노레일 (호텔 경계 공용)',
    generalRestroom: true, accessibleRestroom: true, babyCare: false, nursingRoom: false,
    insidePaidArea: false, generalGuestAccessible: true, pregate: true,
    pdfVerified: true, coordinateVerified: false, approximate: true,
    coordinateStatus: 'unknown', coordinateSourceType: 'pdf_icon_only',
    source: '공식 PDF 베이사이드 스테이션 노란 화장실 아이콘 (4× px 3228,180)',
    sourceUrl: null, checkedAt: '2026-08-01',
    googlePoiName: null,
    evidence: 'PDF 「베이사이드 스테이션」 표기 옆 노란 아이콘. 그랜드 샤토 게이트(hotel-01)·디즈니씨 스테이션(pg01)과 별도.',
    estimatedAccuracyMeters: null, confidenceScore: 10,
    notes: '위치 확인 중. 입구 밖·호텔 경계이나 일반 게스트 이용 가능으로 분류.',
    pdfIconId: 'TDS-MISS-01', pdfPixel: [3228, 180],
  },
  {
    ...
    pdfVerified: true, coordinateVerified: false, approximate: true,
    coordinateStatus: 'low_estimated', coordinateSourceType: 'pdf_landmark',
    source: '공식 PDF 그랜드 샤토 게이트웨이 노란 아이콘 (4× px 3313,447)',
    sourceUrl: null, checkedAt: '2026-08-01',
    googlePoiName: null,
    evidence: 'PDF 「그랜드 샤토 게이트웨이」 표기 옆 노란 아이콘. 일반 게스트 파크 화장실로 등록하지 않음.',
    estimatedAccuracyMeters: 40, confidenceScore: 28,
    notes: '호텔 전용·경계. 기본 지도 비표시.',
    pdfIconId: 'TDS-PDF-03', pdfPixel: [3313, 447],
  },
];
